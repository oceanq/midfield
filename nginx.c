...
#include <nginx.h>
#include <sys/epoll.h>
#define NEDD_INCLUDE_ALL                                                                                                      |
#define NEDK_INCLUDE_ALL
#include <nedk.h>
...
ngx_str_t http_prefix_str;
ngx_str_t https_prefix_str;
ngx_str_t http_proto_str;
ngx_str_t https_proto_str;
...
main(int argc, char *const *argv)
{
	...
	ngx_str_set(&http_prefix_str,"/sslvpn/http/");
	ngx_str_set(&https_prefix_str,"/sslvpn/https/");
	ngx_str_set(&http_proto_str,"http://");
	ngx_str_set(&https_proto_str,"https;//");
